...
Where $g$ is a scalar constant, and $k_L$ and $k_R$ are related proportionality constants to determine the level of of the element $M(S)_n$ within the encoded left and right channels. 
